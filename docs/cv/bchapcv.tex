...
\begin{document}{\Large \textbf{Brandon Chaperon} \hfill\small {\it last upd. Oct/2024} \hphantom{..........................}}
\begin{resume}
	...
	\href{https://www.mcgill.ca/}{\textbf{McGill University}}, Montr\'{e}al, QC, Canada
	...
	\section{\mysidestyle Papers}
	 ...
	 {\textbf{Chaperon, B}. (to appear). A Negative Alternation: Negation Head Movement Allomorphy in Igala. \textit{Selected papers from the 54th Annual Conference on African Linguistics}. Contemporary African Linguistics: Language Science Press, 10. [\href{run:../chaperon_Neg_move.pdf}{pre-pub draft}]}

	 {\textbf{Chaperon, B}. (2023). Unravelling the `not': left peripheral blocking of negation in Kirundi. \textit{Toronto Working Papers in Linguistics}, 46(1). [\href{https://twpl.library.utoronto.ca/index.php/twpl/article/view/39257}{link}]}%\url{https://doi.org/?...}
	...
	\begin{enumerate}[-, leftmargin=1em, topsep=0.5pt]
		...
		\item[] {2023. A negative alternation: Negation head movement allomorphy in Igala. 54th Annual Conference on African Linguistics (\href{https://uconnuecs.cventevents.com/event/aef2d257-6a6a-41b5-b83d-2c6efc60aac5/summary}{ACAL 54}). University of Connecticut. June 12-14. [\href{chaperon\_ACAL54\_Igala\_Negation\_handout.pdf}{handout}]}
		
		\item[] {2022. Focusing on Negation in Kirundi. 1st Toronto-Montreal Bantu Colloquium (\href{https://mcling.blogs.mcgill.ca/2022/05/24/mcgill-at-ba-tom-1/}{Ba-ToM 1}). University of Toronto. May 27-28. [\href{chaperon_bantom_kirundi_neg.pdf}{handout}]}
	\end{enumerate}
...
\end{comment}
	...
	\vspace{-0.6em}\rule{\textwidth}{0.4pt}
		...
		{\textbf{Undergraduate Arts Research Internship Award (ARIA)}. \href{https://www.mcgill.ca/arts-internships/files/arts-internships/brandon_chaperon.pdf}{\textit{Igala Sentence-Final Particles at the edge of \textit{v}P}}. Funded by the Faculty of Arts at McGill University. %Supervised by Martina Martinović. 
	...
	\end{comment}
		...
		\begin{enumerate}[-, leftmargin=1em, topsep=0.5pt]
			...
			%\item[] Remote data elicitation \hfill Feb -- April, 2024
