...
\begin{document}{\Large \textbf{Brandon Chaperon} \hfill\footnotesize {\it last upd. Mar/2026} \hphantom{.............................}}
\begin{resume}

	% === PERSONAL INFO ===
	\vspace{-0.5em}

	\section{\mysidestyle Mail \& links}
	
	\vspace{-0.01em}
	\begin{multicols}{3}

		\faAt{}\hspace{0.1em} \href{mailto:brandon.chaperon@mail.mcgill.ca}{brandon.chaperon@mail.mcgill.ca}%\vspace{0.3em}

		\begin{center}\faChain{}\hspace{0.1em} \href{https://bchap.ca/}{bchap.ca}\end{center}

		\faGithub{}\hspace{0.1em} \href{https://github.com/bchaper0n}{bchaper0n}
	\end{multicols}
	...
	\vspace{-2.3em}\rule{\columnwidth}{0.4pt}
...
\newpage
	...
	\begin{description}
		...
		JavaScript/TypeScript, C, PHP, SQL, Kotlin, C\#, Bash, C++, R, Java
		%(PL), NodeJS, Clojure%(script), OCaml, Julia%(Gen)
	\end{description}
