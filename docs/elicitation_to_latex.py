...
# STEPS:
# 1. create a file named 'input_unformatted_text.txt' in the same path as this python file
# 2. Paste your language examples (with gloss, translation, and/or notes) in created text file as such (without the hashtags):
    ########################################
    # ì nâ l(a) īmótō.                     #
    # 3SG PROG buy car                     #
    ...
    # 3SG PROG go buy car                  #
    # He’s gone to buy a car.              #
    # → answer to where are they?          #
    ########################################
# 3. go into the console in current directory
